...
- [<span class="toc-section-number">1</span>
  080-m2a-host-prediction](#080-m2a-host-prediction)
  - [<span class="toc-section-number">1.1</span> Pull the stashed Yahara
    contig metadata](#pull-the-stashed-yahara-contig-metadata)
  - [<span class="toc-section-number">1.2</span> Parse the CAT taxonomy
    string](#parse-the-cat-taxonomy-string)
  - [<span class="toc-section-number">1.3</span> Restrict to actionable
    ranks (genus / species /
    etc.)](#restrict-to-actionable-ranks-genus--species--etc)
  - [<span class="toc-section-number">1.4</span> Build `phage_host_link`
    rows](#build-phage_host_link-rows)
  - [<span class="toc-section-number">1.5</span> Write to the contract
    layer](#write-to-the-contract-layer)
  - [<span class="toc-section-number">1.6</span> Persist](#persist)
...
**Updated: 2026-05-05 15:17:59 CET.**
...
|:--------------------|:-----|-----:|:--------------------|
| phage_host_link.csv | file | 335K | 2026-05-05 15:18:00 |
