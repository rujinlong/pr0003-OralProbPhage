...
- [<span class="toc-section-number">1</span> Oral probiotic phage
  knowledge layer — MVP data
  report](#oral-probiotic-phage-knowledge-layer--mvp-data-report)
- [<span class="toc-section-number">2</span> Data layer](#data-layer)
- [<span class="toc-section-number">3</span> Sources used in the
  MVP](#sources-used-in-the-mvp)
- [<span class="toc-section-number">4</span> MVP figures](#mvp-figures)
- [<span class="toc-section-number">5</span> Methods
  (skeleton)](#methods-skeleton)
- [<span class="toc-section-number">6</span> What’s deferred to ripple
  (manuscript-blocking
  items)](#whats-deferred-to-ripple-manuscript-blocking-items)
- [<span class="toc-section-number">7</span> References](#references)
  - [<span class="toc-section-number">7.1</span> Files
